...
class Database:
    ...
    def add_to_watchlist(self, user_id, content_type, item_id, title, poster_path):
        ...
        (user_id, content_type, item_id, title, poster_path, date_added) 
        VALUES (%s, %s, %s, %s, %s, %s)
    ...
    def remove_from_watchlist(self, user_id, content_type, item_id):
        ...
        WHERE user_id = %s AND content_type = %s AND item_id = %s
        """
    ...
    def update_notification_settings(self, user_id, enabled=None, frequency=None, content_type=None):
        ...
        (user_id, enabled, frequency, content_type) 
        VALUES (%s, %s, %s, %s)
...
if __name__ == '__main__':
    ...
    flask_thread.start()
    logger.info(f"🚀 Flask health check running on port {Config.PORT}")
